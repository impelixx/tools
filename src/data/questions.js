export const allQuestions = [
  ...
  {
    category: "practice",
    question: "Что будет, если сделать chmod +x folder",
    options: [
      "Папка станет исполняемой",
      "Папку разорвет на куски по компьютеру",
      "Пользователи смогут заходить в папку",
      "пользователи могут смотреть что находится в папке, но не могут заходить в неё"
    ],
    correct: 2
  },
  {
    category: "practice",
    question: "Можно ли войти в системного пользователя как в обычного",
    options: [
      "Да",
      "Нет",
      "Да, если повезет",
